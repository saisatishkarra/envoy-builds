...
#source "${ENVOY_BUILDS_SCRIPT_DIR}/scripts/bazel_env/${DISTRO}.sh"

export BUILD_TARGET=${BUILD_TARGET:-"//contrib/exe:envoy-static"}

export CONTRIB_ENABLED_MATRIX_SCRIPT="${ENVOY_BUILDS_SCRIPT_DIR}/util/extensions.py"
...
export BAZEL_BUILD_EXTRA_OPTIONS=${BAZEL_BUILD_EXTRA_OPTIONS:-"--distdir ${BAZEL_DEPS_BASE_DIR}"}
